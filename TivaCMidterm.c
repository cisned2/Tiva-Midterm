...
void main (void)
{
    ...
    HibernateRTCMatchSet (0, HibernateRTCGet()+30); //hibernate for 30 seconds
 ...
 //   UARTprintf ("AT+CWJAP=\"AndroidAP\", \"djaa2951\"\r\n");
 //   SysCtlDelay (100000000);
    ...
    usprintf (HTTP_POST, "GET /update?key=3EDMW4MC3MNPSGN5&field1=%d&headers=falseHTTP/1.1\nHostapi.thingspeak.com\nConnection:close\Accept*\*\r\n\r\n", luxAvg);
